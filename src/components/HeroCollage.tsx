  ...
  return (
    <div className="collage-root">
      ...
      <article className="collage-tile collage-process">
        ...
        <img src={portraits.bottom} alt="Coach profile" className="collage-photo-bottom" />

        <div className="process-badges">
          <span className="collage-badge collage-badge-tools">
            mentoring de liderazgo
            <span className="badge-plus-icon" aria-hidden="true">
              +
            </span>
          </span>

          <span className="collage-badge collage-badge-process">
            <span className="badge-plus-icon" aria-hidden="true">
              +
            </span>
            team building estrategico
          </span>
        </div>
      </article>

      <span className="collage-badge collage-badge-personalized">
